...
def main(maintype):
    ...
    if maintype=='fast2conll':
        ...
        mainPath = '/home/hanwj/Code/l_dmv/data/ud-treebanks-v1.4/WSJ'
        # langs = ['arabic', 'basque', 'czech', 'danish', 'dutch', 'portuguese', 'slovene', 'swedish']
        instc = 'lndmv_test.txt'
        # intdep = 'train_ndmv_init_conll'
        outstc = 'wsj-ud-test-nopunct-len40.conllu'
        for i in range(1):
...
if __name__ == "__main__":
    main_type = 'limitto10' #'limitto10' #'loadmodel_sentencerepresent' #'conllforHDPDEP' #'pascalprocess'  # pascalinit_utf  #  loadmodel_sentencerepresent  # 'pascalprocess'
    main(main_type)